...
class Profile extends React.Component {
    ...
    render() {
        ...
        const bioPass = "Hello there, my name is Filip Saulean. I can unequivocally say that I " +
        "am focused and dedicated to seeing my goals brought to fruition. In addition, I can " +
        "assure you that I am a fast learner so if you need me to learn a new library or language, " +
        "I will do so in an expedient manner. My personal site was built with React and node.js. PS: I am " +
        "also fascinated with antiquity, Roman culture, and Hellenism.";
        const languages = {
            csharp: {
                name: "C#",
        ...
        const contactInformation = {
            personal: { name: "fsaulean@gmail.com"},
        ...
        return(
            <div
                ...
                className={ this.state.check ? "element-move-in container-profile" : "element-move-out container-profile" }
            >
